    ...
    <div className="min-h-screen bg-gray-100 font-sans antialiased text-gray-900">
      <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
        ...
        {view === 'dashboard' && user && appData && (
          <DashboardPage user={user} db={appData.db} onLogout={handleLogout} />
        )}
      </div>
    </div>
  );
...
const DashboardPage = ({ user, db, onLogout }) => {
  ...
  const PromoteModal = () => {
    ...
    return (
      <div className="p-6">
        ...
        <p className="mb-4">Selecciona una red social y el valor en puntos para que otros te sigan. Los puntos se descontarán de tu saldo cuando alguien complete la tarea.</p>
  ...
  const EarnPointsModal = () => {
    ...
    const handleCompleteTask = async (taskId, taskPoints, taskOwnerId) => {
      ...
      try {
        ...
        // Descontar puntos al dueño de la tarea
        await updateDoc(ownerRef, {
          points: (await getDoc(ownerRef)).data().points - taskPoints,
        });
        
        // Eliminar la tarea (simulando que se ha completado)
        // await deleteDoc(taskRef);
        console.log(`Tarea ${taskId} completada. Ganaste ${taskPoints} puntos.`);
    ...
    return (
      <div className="p-6">
        ...
        <p className="mb-4">Completa las siguientes tareas para ganar puntos. Al hacer clic en "Completar", los puntos se acreditarán a tu cuenta y se descontarán al usuario que promociona.</p>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <a href={task.link} target="_blank" rel="noopener noreferrer" className="text-sm text-blue-500 hover:underline">
                      Visitar <FaExternalLink className="inline-block text-xs ml-1" />
                    </a>
                  </div>
                </div>
